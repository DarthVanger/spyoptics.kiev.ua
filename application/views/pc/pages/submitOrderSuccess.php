...
<div id="submitOrderSuccess-page" class="page-padding text">
	<div>
        ...
        <div>
            <p>
                В данный момент администрация  интернет магазина в отпуске. Все заказы и сообщения для компании, присланные с 08.07.2017 по 23.07.2017, будут обработаны 27.07.2017.
            </p>
