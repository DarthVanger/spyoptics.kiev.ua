...
<div id="submitOrderSuccess-page" class="page-padding text">
	<div>
      ...
      -->
        ...
        <div>
            <p>
                В данный момент администрация  интернет магазина в отпуске. Все заказы и сообщения для компании, присланные с с 09.11 до 18.11, будут обработаны 19.11.2017.
            </p>
